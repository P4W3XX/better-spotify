    ...
    return (
        <main className="flex flex-col items-center justify-center h-screen bg-gradient-to-t from-black from-40% to-green-900 w-full">
            ...
            <form className="flex flex-col gap-4 justify-center items-center w-full">
                <input type="text" placeholder="Username" className="rounded-lg px-5 py-3 w-[20rem] border border-3 border-gray-600 text-gray-300"/>
                <input type="password" placeholder="Password"  className="rounded-lg px-5 py-3 w-[20rem] border border-3 border-gray-600"/>
