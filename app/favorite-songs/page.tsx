        ...
        >
                    ...
                    {isLoading ? (
                        ...
                        <button onClick={() => {
                            if (songs.length > 0 && songs[0]) {
                                if (currentSongID && songs.some(song => song.id.toString() === currentSongID.url)) {
                                    if (action === "Play") {
                                        setAction("Pause");
                                    } else {
                                        setAction("Play");
                            ...
                            {currentSongID && songs.some(song => song.id.toString() === currentSongID.url) ? (
                                action === "Play" ? (
            ...
            <div className=" w-full h-full space-y-3 flex flex-col bg-black/60">
                <div
                    ...
                    style={{
                        backgroundColor: scrollY > 300 ? '#00B2FF' : "transparent",
